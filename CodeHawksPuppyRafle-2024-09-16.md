...
I, Mufassir, am a web3 full-stack developer taking on a journey in the web3 security world. I've been building dApps for the good half of a year with Niftables using different ERC standards including ERC-20, ERC-721, ERC-721C, ERC-721A, EIP-712, markel-trees and different DeFi protocols such as UniSwap, SushiSwap, MakerDAO etc.

# Disclaimer

The Mufassir shah team makes all effort to find as many vulnerabilities in the code in the given time period, but holds no responsibilities for the the findings provided in this document. A security audit by the team is not an endorsement of the underlying business or product. The audit was time-boxed and the review of the code was solely on the security aspects of the solidity implementation of the contracts.
